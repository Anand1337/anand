...
impl DBCol {
    ...
    /// Returns a list of all columns sorted by their usize value.
...
impl fmt::Display for DBCol {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        let desc = match self {
            ...
            Self::State128MIB => "blockchain state (128MB)",
            Self::State256MIB => "blockchain state (256MB)",
            Self::State512MIB => "blockchain state (512MB)",
            Self::State1024MIB => "blockchain state (1024MB)",
