...
use near_store::db::{DBCol::ColState, DBTransaction, Database, RocksDB};
...
impl Storage {
    ...
    fn commit(&mut self) {
        self.db.write(replace(&mut self.tx, new_tx())).unwrap();
    }
