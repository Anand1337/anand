...
impl EpochManager {
    ...
    pub fn get_validator_info(
        ...
        info!(target:"stats", "get validator info 2");
        ...
        info!(target:"stats", "get validator info 3");
        ...
        info!(target:"stats", "get validator info end");
...
impl EpochManager {
    ...
    pub fn get_and_update_epoch_info_aggregator(
        ...
        info!(target:"stats", "update epoch info aggregator {:?} {:?}", cur_hash, aggregator.last_block_hash);
