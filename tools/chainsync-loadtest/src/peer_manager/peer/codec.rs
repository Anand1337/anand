/// The purpose of this crate::peer_manager is to encode/decode messages on the network layer.
...
#[cfg(test)]
mod test {
    use crate::peer_manager::peer::codec::{Codec, NETWORK_MESSAGE_MAX_SIZE_BYTES};
    use crate::peer_manager::types::{Handshake, PeerMessage, RoutingTableUpdate};
