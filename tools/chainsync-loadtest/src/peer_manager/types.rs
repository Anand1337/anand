...
pub enum PeerManagerMessageRequest {
    ...
    GetPeerId(crate::peer_manager::private_actix::GetPeerId),
    ...
    #[cfg(feature = "test_features")]
    #[cfg(feature = "protocol_feature_routing_exchange_algorithm")]
    StartRoutingTableSync(crate::peer_manager::private_actix::StartRoutingTableSync),
    #[cfg(feature = "test_features")]
    SetAdvOptions(crate::peer_manager::test_utils::SetAdvOptions),
    #[cfg(feature = "test_features")]
    #[cfg(feature = "protocol_feature_routing_exchange_algorithm")]
    SetRoutingTable(crate::peer_manager::test_utils::SetRoutingTable),
}
...
pub enum PeerManagerMessageResponse {
    ...
    #[cfg(feature = "test_features")]
    GetPeerIdResult(crate::peer_manager::private_actix::GetPeerIdResult),
    OutboundTcpConnect(()),
    InboundTcpConnect(()),
    Unregister(()),
    Ban(()),
...
impl PeerManagerMessageResponse {
    ...
    #[cfg(feature = "test_features")]
    pub fn as_peer_id_result(self) -> crate::peer_manager::private_actix::GetPeerIdResult {
