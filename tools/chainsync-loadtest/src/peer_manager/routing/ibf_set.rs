use crate::peer_manager::routing::ibf::{Ibf, IbfBox};
use crate::peer_manager::routing::ibf_peer_set::{SlotMapId, ValidIBFLevel, MAX_IBF_LEVEL, MIN_IBF_LEVEL};
...
#[cfg(test)]
mod test {
    use crate::peer_manager::routing::ibf_peer_set::{SlotMapId, ValidIBFLevel};
    use crate::peer_manager::routing::ibf_set::IbfSet;
