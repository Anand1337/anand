...
use crate::peer_manager::routing::routing_table_view::SAVE_PEERS_MAX_TIME;
...
pub struct RoutingTableActor {
    ...
    pub peer_ibf_set: crate::peer_manager::routing::ibf_peer_set::IbfPeerSet,
...
pub enum RoutingTableMessages {
    ...
    #[cfg(feature = "protocol_feature_routing_exchange_algorithm")]
    ProcessIbfMessage { peer_id: PeerId, ibf_msg: crate::peer_manager::types::RoutingVersion2 },
...
pub enum RoutingTableMessagesResponse {
    ...
    ProcessIbfMessageResponse {
        ibf_msg: Option<crate::peer_manager::types::RoutingVersion2>,
    },
    ...
    #[cfg(feature = "protocol_feature_routing_exchange_algorithm")]
    StartRoutingTableSyncResponse(crate::peer_manager::types::RoutingSyncV2),
...
impl RoutingTableActor {
    pub fn exchange_routing_tables_using_ibf(
        &self,
        peer_id: &PeerId,
        ibf_set: &crate::peer_manager::routing::IbfSet<near_network_primitives::types::SimpleEdge>,
        ibf_level: crate::peer_manager::routing::ibf_peer_set::ValidIBFLevel,
        ibf_vec: &[crate::peer_manager::routing::ibf::IbfBox],
        seed: u64,
    ) -> (Vec<near_network_primitives::types::SimpleEdge>, Vec<u64>, u64) {
        let ibf = ibf_set.get_ibf(ibf_level);

        let mut new_ibf = crate::peer_manager::routing::ibf::Ibf::from_vec(ibf_vec, seed ^ (ibf_level.0 as u64));
        ...
        match msg {
            ...
            RoutingTableMessages::StartRoutingTableSync { seed } => {
                RoutingTableMessagesResponse::StartRoutingTableSyncResponse(
                    crate::peer_manager::types::RoutingSyncV2::Version2(crate::peer_manager::types::RoutingVersion2 {
                        known_edges: self.edges_info.len() as u64,
                        seed,
                        edges: Default::default(),
                        routing_state: crate::peer_manager::types::RoutingState::InitializeIbf,
                    }),
                )
            }
            #[cfg(feature = "protocol_feature_routing_exchange_algorithm")]
            ...
            RoutingTableMessages::ProcessIbfMessage { peer_id, ibf_msg } => {
                match ibf_msg.routing_state {
                    crate::peer_manager::types::RoutingState::PartialSync(partial_sync) => {
                        if let Some(ibf_set) = self.peer_ibf_set.get(&peer_id) {
                            ...
                            {
                                crate::peer_manager::types::RoutingVersion2 {
                                    known_edges: self.edges_info.len() as u64,
                                    seed,
                                    edges: edges_for_peer,
                                    routing_state: crate::peer_manager::types::RoutingState::RequestMissingEdges(
                                        unknown_edge_hashes,
                                    ),
                                }
                                ...
                                crate::peer_manager::types::RoutingVersion2 {
                                    ...
                                    seed,
                                    edges: edges_for_peer,
                                    routing_state: crate::peer_manager::types::RoutingState::Done,
                                }
                                ...
                                crate::peer_manager::types::RoutingVersion2 {
                                    ...
                                    seed,
                                    edges: edges_for_peer,
                                    routing_state: crate::peer_manager::types::RoutingState::PartialSync(
                                        crate::peer_manager::types::PartialSync {
                                ...
                                crate::peer_manager::types::RoutingVersion2 {
                                    ...
                                    routing_state: crate::peer_manager::types::RoutingState::RequestAllEdges,
                                }
                            };
                    ...
                    crate::peer_manager::types::RoutingState::InitializeIbf => {
                        ...
                        if let Some(ibf_set) = self.peer_ibf_set.get(&peer_id) {
                            ...
                            let ibf_vec =
                                ibf_set.get_ibf_vec(crate::peer_manager::routing::ibf_peer_set::MIN_IBF_LEVEL);
                            RoutingTableMessagesResponse::ProcessIbfMessageResponse {
                                ibf_msg: Some(crate::peer_manager::types::RoutingVersion2 {
                                    known_edges: self.edges_info.len() as u64,
                                    seed,
                                    edges: Default::default(),
                                    routing_state: crate::peer_manager::types::RoutingState::PartialSync(
                                        crate::peer_manager::types::PartialSync {
                                            ibf_level: crate::peer_manager::routing::ibf_peer_set::MIN_IBF_LEVEL,
                                            ibf: ibf_vec.clone(),
                                        },
                                    ),
                                }),
                    ...
                    crate::peer_manager::types::RoutingState::RequestMissingEdges(requested_edges) => {
                        let seed = ibf_msg.seed;
                        ...
                        let ibf_msg = crate::peer_manager::types::RoutingVersion2 {
                            known_edges: self.edges_info.len() as u64,
                            seed,
                            edges: edges_for_peer,
                            routing_state: crate::peer_manager::types::RoutingState::Done,
                    ...
                    crate::peer_manager::types::RoutingState::RequestAllEdges => {
                        RoutingTableMessagesResponse::ProcessIbfMessageResponse {
                            ibf_msg: Some(crate::peer_manager::types::RoutingVersion2 {
                                known_edges: self.edges_info.len() as u64,
                                seed: ibf_msg.seed,
                    ...
                    crate::peer_manager::types::RoutingState::Done => {
