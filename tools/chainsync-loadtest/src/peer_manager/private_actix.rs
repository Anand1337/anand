/// This file is contains all types used for communication between `Actors` within this crate::peer_manager.
/// They are not meant to be used outside.
use crate::peer_manager::network_protocol::PeerMessage;
