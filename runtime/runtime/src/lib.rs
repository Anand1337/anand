    ...
    pub fn apply(
        ...
        let mut process_receipt = |receipt: &Receipt,
         ...
         -> Result<_, RuntimeError> {
            let _span = tracing::debug_span!(target: "runtime", "Runtime::process_receipt", receipt_id = %receipt.receipt_id, node_counter = state_update.get_touched_nodes_count()).entered();
            ...
            tracing::debug!(target: "runtime", node_counter = state_update.get_touched_nodes_count());
